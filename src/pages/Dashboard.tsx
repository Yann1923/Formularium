    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
        ...
        <div className="relative z-10">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-8">
            <div className="flex items-center space-x-4 mb-6 lg:mb-0">
              ...
              <div>
                <h1 className="text-4xl lg:text-5xl font-bold mb-2 drop-shadow-lg">Dashboard</h1>
                <p className="text-blue-100 text-lg">
                  Selamat datang, <span className="font-semibold text-white">{user?.fullName}</span>!
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white/15 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:bg-white/20 transition-all duration-300">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-blue-100 text-sm font-medium mb-2">Total Obat</p>
                  <p className="text-3xl font-bold text-white mb-1">{medicines.length}</p>
            ...
            <div className="bg-white/15 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:bg-white/20 transition-all duration-300">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-blue-100 text-sm font-medium mb-2">Total Penyakit</p>
                  <p className="text-3xl font-bold text-white mb-1">{diseases.length}</p>
            ...
            <div className="bg-white/15 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:bg-white/20 transition-all duration-300">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-blue-100 text-sm font-medium mb-2">Total Stok</p>
                  <p className="text-3xl font-bold text-white mb-1">
                    {medicines.reduce((total, medicine) => total + medicine.stock, 0)}
                  </p>
      ...
      <div className="px-6 lg:px-8 space-y-8">
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600">Navigasi cepat ke fitur utama sistem</p>
            </div>
          </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm font-medium text-blue-700 mb-1">Kelola Obat</p>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm font-medium text-green-700 mb-1">Data Penyakit</p>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm font-medium text-purple-700 mb-1">Stok Total</p>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm font-medium text-orange-700 mb-1">Pengguna</p>
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-2">Status & Peringatan</h2>
              <p className="text-gray-600">Pantau kondisi obat yang memerlukan perhatian khusus</p>
            </div>
          ...
          <CardContent>
            {lowStockMedicines.length > 0 ? (
              <div className="space-y-3 p-6">
                ...
                {lowStockMedicines.length > 5 && (
                  <div className="text-center p-3 bg-red-50 rounded-lg border border-red-100">
                    <p className="text-sm text-red-600 font-medium">
                      +{lowStockMedicines.length - 5} obat lainnya dengan stok rendah
                    </p>
                  </div>
                )}
              </div>
              ...
              <div className="p-6 text-center">
                ...
                <p className="text-green-600 font-medium mb-2">Semua Stok Aman!</p>
          ...
          <Card className="shadow-xl border-0 bg-gradient-to-br from-orange-50 to-orange-100 overflow-hidden hover:shadow-2xl transition-all duration-300">
            <CardHeader className="pb-4 bg-gradient-to-r from-orange-500 to-orange-600 text-white">
              <CardTitle className="flex items-center space-x-3">
                ...
                <div>
                  <span className="text-lg font-bold">Obat Akan Kedaluwarsa</span>
          ...
          <CardContent>
            {expiringSoonMedicines.length > 0 ? (
              <div className="space-y-3 p-6">
                {expiringSoonMedicines.slice(0, 5).map((medicine) => (
                  ...
                  >
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-xs text-orange-600 mt-1">Segera kedaluwarsa</p>
                    </div>
                  </div>
                ))}
                {expiringSoonMedicines.length > 5 && (
                  <div className="text-center p-3 bg-orange-50 rounded-lg border border-orange-100">
                    <p className="text-sm text-orange-600 font-medium">
                      +{expiringSoonMedicines.length - 5} obat lainnya akan kedaluwarsa
                    </p>
                  </div>
                )}
              </div>
              ...
              <div className="p-6 text-center">
                ...
                <p className="text-green-600 font-medium mb-2">Semua Tanggal Aman!</p>
                <p className="text-green-500 text-sm">
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-2">Data Obat Terkini</h2>
              <p className="text-gray-600">Daftar obat yang tersedia dalam sistem formularium</p>
            </div>
              ...
              >
                ...
                <div className="text-right">
                  <div className="flex items-center space-x-2 mb-2">
                    <span className={`w-3 h-3 rounded-full ${medicine.stock > 50 ? 'bg-green-400' : medicine.stock > 20 ? 'bg-yellow-400' : 'bg-red-400'}`}></span>
